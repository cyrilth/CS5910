...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2014 at 04:49 PM
...
INSERT INTO `admins` (`AdminID`, `AccessCode`, `Role`) VALUES
(1, 0, 'admin'),
(19, 0, 'admin');
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  `CreditsTaken` int(4) NOT NULL,
  `CreditsEarned` int(4) NOT NULL,
  `GPA` float NOT NULL,
  `ClassStanding` varchar(10) NOT NULL DEFAULT 'Good',
...
--
ALTER TABLE `sections`
MODIFY `SectionID` int(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
